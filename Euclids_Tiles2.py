...
# display the floor
def display_floor(room_width, room_height, tile, canvas):
...
# display tile size
def display_tile_size(room_width, room_height, tile, canvas):
    # initalise vaiables
    number_of_tiles_X = room_width // tile
    number_of_tiles_Y = room_height // tile
...
display_floor(room_long, room_short, tile_size, canvas)
display_tile_size(room_long, room_short, tile_size, canvas)
